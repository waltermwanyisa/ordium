...
const BASE_URL = "https://my-json-server.typicode.com/themeland/gameon-json-3/single";
          ...
          <div className="col-12 col-lg-8 p-0">
            <div className="row">
              <div className="col-12 align-self-center">
                  ...
                  <li className="post-meta-item">
                    <div className="date">
                      <span className="posted-on">Posted On {" "}
                        <a href="/blog-single" rel="bookmark">
                          <time className="entry-date published updated" dateTime="2018-11-01T06:18:46+00:00">
                            {data.date}
                          </time>
                        </a>
                      </span>
                ...
                {/* Comments */}
                <h3 className="comments-reply-text mb-3">{data.commentTitle}</h3>
                ...
                <form>
                  <fieldset>
                    ...
                    <div className="col-12 input-group p-0">
                      <button className="btn btn-bordered-white text-white">
                        {data.commentBtn}
